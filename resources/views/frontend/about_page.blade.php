                ...
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <div class="about__exp">
                            ...
                            <div class="about__exp__content" style="font-family: 'Noto Sans Thai', sans-serif;">
                                <p><span>{{ $aboutpage->short_title }}</span></p>
                            </div>
                        </div>
                        <p class="desc" style="font-family: 'Noto Sans Thai', sans-serif;">{{ $aboutpage->short_description }}</p>
                ...
                <div class="col-12">
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" style="font-family: 'Noto Sans Thai', sans-serif;" id="about" role="tabpanel" aria-labelledby="about-tab">
                                <p class="desc">
